...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<ProvinceBean> options1Items = new ArrayList<>();//一级联动查询
    private ArrayList<ArrayList<String>> options2Items = new ArrayList<>();//二级联动查询
    private ArrayList<ArrayList<ArrayList<String>>> options3Items = new ArrayList<>();//三级联动查询
    ...
    private void initTimePicker() {
        ...
        pvTime = new TimePickerView.Builder(this, new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                ...
                .setDate(selectedDate)
                .setRangDate(startDate, endDate)
                .setBackgroundId(0xFF0000) //设置外部遮罩颜色
                .setDecorView(null)
                .build();
    }
    ...
    private void initOptionData() {
        ...
        //选项三
        ArrayList<ArrayList<String>> option3Items_01 = new ArrayList<ArrayList<String>>();
        ArrayList<String> option3_1_Items_01 = new ArrayList<String>();
        option3_1_Items_01.add("广州1");
        option3_1_Items_01.add("广州2");
        option3_1_Items_01.add("广州3");
        option3Items_01.add(option3_1_Items_01);
        options3Items.add(option3Items_01);
        /*--------数据源添加完毕---------*/
    }
